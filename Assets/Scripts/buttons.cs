...
public class buttons : MonoBehaviour
{
    ...
    {
        if (mainCharacter.hotKey2 == false) { mainCharacter.hotKey2 = true; Debug.Log(mainCharacter.hotKey2); shootingScript.archers = true; }
        else if (mainCharacter.hotKey2 == true) { mainCharacter.hotKey2 = false; Debug.Log(mainCharacter.hotKey2); shootingScript.archers = false; }
        mainCharacter.hotKeyTimer = 0;
    }
    public void HotKey3Methode()
    {
        if (mainCharacter.hotKey3 == false) { mainCharacter.hotKey3 = true; Debug.Log(mainCharacter.hotKey3); shootingScript.archers = true; }
        else if (mainCharacter.hotKey3 == true) { mainCharacter.hotKey3 = false; Debug.Log(mainCharacter.hotKey3); shootingScript.archers = false; }
        mainCharacter.hotKeyTimer = 0;
    }
